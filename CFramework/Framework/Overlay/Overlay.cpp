...
bool Overlay::CreateOverlay()
{
    ...
    RegisterClassExA(&wc);
    m_Hwnd = CreateWindowExA(DefaultStyle, wc.lpszClassName, wc.lpszMenuName, WS_POPUP | WS_VISIBLE, g.g_GamePoint.x, g.g_GamePoint.y, g.g_GameRect.right, g.g_GameRect.bottom, NULL, NULL, wc.hInstance, NULL);
